...
@section('content')
    <section class="pabout">
        ...
        <div class="banner__bottom">
            <img src="/img/banner_bot_green.svg" alt="banner">
        </div>
    </section>
        ...
        <div class="t__conteiner">
            <div class="btn-t_agency">
                <a href="{{ route('a_travel_agency', app()->getLocale()) }}.html#block-form">
                    <img class="img_agency" src="/img/GGroup3.png">
                </a>
            </div>
            <div class="t__content">
                <h1>Are you a travel agency ? Do you<br> need to secure transport for your<br> customers ? </h1>
            </div>
        </div>
    </section>

    <section class="pabout">
        <header class="group_agency_t">
            <div class="container">
                <h1 style="text-align: center;font-family: 'Roboto';font-style: normal;font-weight: 700;line-height: 40px;font-size: 32px; padding-top: 30%;">Do you consider working with us ? Are you a travel agency ? You are in the right<br> place ! If this offer strikes you, you have to take few steps. There is a register<br> system you need to find and we will reach out to you within 24 hours to give you<br> further instructions. </h1>
    ...
    <section class="coopirate">
        ...
        <div class="coopirate__wrapper">
            <div class="coopirate__inner">
                <div class="coopirate__item green">
    ...
    <section class="coopirate">
        ...
        <div class="coopirate__content">
            <img class="coopirate__content__img desktop-scheme" src="/img/GGroup2.jpg">
            <img class="coopirate__content__img mobile-scheme" src="/img/scheme-green.png">
        </div>
    </section>
    ...
    <section>
        <div class="conditions_conteiner">
            ...
            <div class="btn_partner">
                ...
                <a type="button" class="travel__btn travel__btn4" name="travel" href="{{ route('a_travel_agency', app()->getLocale()) }}.html#block-form">Become a Travel agency</a>
            </div>
        </div>
@endsection
