...
@section('content')
    <section class="pabout">
        ...
        <div class="banner__bottom">
            <img src="/img/banner_bot_blue.svg" alt="banner">
        </div>
    </section>
        ...
        <div class="t__conteiner">
            <div class="btn-t_agency">
                <a href="{{ route('a_travel_agency', app()->getLocale()) }}.html#block-form">
                    <img class="img_agency" src="/img/BGroup3.png">
                </a>
            </div>
            <div class="t__content">
                <h1>Are you a ship transport for passengers ?<br> Do you need to secure transport for your<br> customers ?</h1>
            </div>
        </div>
    </section>

    <section class="pabout">
        <header class="group_agency_s">
            <div class="container">
    ...
    <section class="coopirate">
        ...
        <div class="coopirate__wrapper">
            <div class="coopirate__inner">
                <div class="coopirate__item blue">
    ...
    <section class="coopirate">
        ...
        <div class="coopirate__content">
            <img class="coopirate__content__img desktop-scheme" src="/img/BGroup2.jpg">
            <img class="coopirate__content__img mobile-scheme" src="/img/scheme-blue.png">
        </div>
    </section>
    ...
    <section>
        <div class="conditions_conteiner">
            ...
            <div class="btn_partner">
                ...
                <a type="button" class="travel__btn travel__btn2" name="travel" href="{{ route('a_travel_agency', app()->getLocale()) }}.html#block-form">Become a Travel agency</a>
            </div>
        </div>
@endsection
